"""Preview initial string-similarity features from interim pair-table JSONL files."""
...
from entity_matching.features import build_string_similarity_features
            ...
            previews.append(
                {
                    ...
                    "features": build_string_similarity_features(standardized),
                }
            )
